...
save_plot <- function(name, type, outformat, h, w) {  \n\
  ...
  \n\
my_plot  <-  function(hist, name, h=4.5, w=4.5, x_max, type, pdf=FALSE, s1) {  \n\
  \n\
  ...
  \n\
my_plot(hist = args$file, name = args$output, h = args$ydim, w = args$xdim, type = args$type, pdf = args$pdf, s1 = args$source2)  \n\
";
